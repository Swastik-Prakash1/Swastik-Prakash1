...
I am a Computer Science undergraduate (B.Tech CSE '27) based in India, specializing in **AI Systems Engineering**. 

I build across the full ML stack—from scientific deep learning and real-time inference pipelines to multi-agent decision systems and applied computer vision. My engineering philosophy is simple: **Use deterministic logic, physics, or explicit structured scoring where reliability matters; use LLMs and learned models where perception, reasoning, and explanation provide genuine value.**

```python
class Swastik:
    focus       = ["Agentic AI", "Computer Vision", "Real-Time Inference", "Scientific ML"]
    open_to     = ["Internships", "Research Collaborations", "Open Source"]
    philosophy  = "Ship fast | Think deep | Build real"
